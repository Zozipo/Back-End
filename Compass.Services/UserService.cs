    ...
    public class UserService
    {
        ...
        public async Task<ServiceResponse> UpdateProfileAsync(UpdateProfileVM model)
        {
            ...
            else
            {
                ...
                {
                    var confirmationResut = await _userRepository.UnconfirmEmailAsunc(user);
                ...
                var result = await _userRepository.UpdateProfileAsync(updatedUser);
                if (result.Succeeded)
                {
                    var tokens = await _jwtService.GenerateJwtTokenAsync(updatedUser);
